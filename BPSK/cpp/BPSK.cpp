...
/***********************************************************************************************
    ...
    Properties:
        ...
        addPropertyChangeListener(<property name>, this, &BPSK_i::<callback method>)
        in the constructor.
        ...
        BPSK_i::BPSK_i(const char *uuid, const char *label) :
            BPSK_base(uuid, label)
        {
            addPropertyChangeListener("scaleValue", this, &BPSK_i::scaleChanged);
        }

        void BPSK_i::scaleChanged(const float *oldValue, const float *newValue)
        {
